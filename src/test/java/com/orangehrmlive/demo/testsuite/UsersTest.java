...
public class UsersTest extends BaseTest {
    ...
    public void adminShouldAddUserSuccessFully() {
        ...
        addUsersPage.sendDataToUserNameFieldInAddUser("manish123");
        addUsersPage.clickOnStatusDropDownMenuInAddUser();
        addUsersPage.mouseHoverAndClickOnDisabledOptionInAddUser();
        addUsersPage.sendDataToPasswordFieldInAddUser("manish123");
        addUsersPage.sendDataToConfirmPasswordFieldInAddUser("manish123");
    ...
    public void searchTheUserCreatedAndVerifyIt() {
        ...
        viewSystemUsersPage.sendDataToUserNameFieldInSystemUsers("manish123");
        ...
        String expectedUserName = "manish123";
